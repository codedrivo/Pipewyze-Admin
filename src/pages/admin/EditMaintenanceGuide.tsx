...
import { useEditMaintenanceGuide } from "./useEditMaintenanceGuide";
import form from "../../components/UI/form/formcus.module.scss";
import Input from "../../components/UI/input/Input";
import LoadingSpinner from "../../components/UI/loadingSpinner/LoadingSpinner";
import withRole from "../withRole";

function EditMaintenanceGuide() {
  const {
    navigate,
    fileInputRef,
    loading,
    ...
    >
      <div className='profile-card'>
        ...
        <div className='gc-profile-flex'>
          <h2>Edit Maintenance Guide</h2>
          <button
            type='button'
            onClick={() => navigate("/admin/maintenance-guides")}
...
export default withRole(EditMaintenanceGuide, ["admin"]);
