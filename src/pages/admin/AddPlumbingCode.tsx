...
import { useAddPlumbingCode } from "./useAddPlumbingCode";
import form from "../../components/UI/form/formcus.module.scss";
import Input from "../../components/UI/input/Input";
import withRole from "../withRole";
import Editor from "../../components/common/Editor";

function AddPlumbingCode() {
  const { navigate, submitting, formik, categories } = useAddPlumbingCode();
        ...
        >
          ...
          <div className='submitbtnwrap' style={{ marginTop: "30px" }}>
            <button
              ...
              disabled={submitting}
            >
              {submitting ? "Saving..." : "Add Plumbing Code"}
            </button>
          </div>
        </form>
      </div>
...
export default withRole(AddPlumbingCode, ["admin"]);
