...
import { useEditSubscriptionPlan } from "./useEditSubscriptionPlan";
      ...
      <div className="edit-plan-card">
        ...
        >
          <div>
            ...
            >
              Update subscription tier settings, trial periods, pricing, and section access permissions.
            </p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={formik.handleSubmit} autoComplete="off">
          ...
          >
            ...
            {/* SECTION 5: Active Status & Submission */}
            <div
              style={{
                display: "flex",
                alignItems: "center",
...
export default withRole(EditSubscriptionPlan, ["admin"]);
